...
<NextImage
  ...
  alt="an ordered list with two items starting from number 5"
/>
...
<NextImage
  ...
  alt="an ordered list with three items starting from number 1 but in reversed order"
/>
...
<NextImage
  ...
  alt="an ordered list with three items starting from number 1"
/>
...
<NextImage
  ...
  height={400}
  unoptimized
  alt="an ordered list with four items starting from number 1 and the third item number reset to 1 again"
...
<NextImage
  ...
  alt="an ordered list with 3 items starting from number 10"
/>
...
<NextImage
  ...
  alt="an ordered list with 3 items starting from number 10 with bullet numbers colored red"
/>
